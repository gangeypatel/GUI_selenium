...
class TestTestCase0():
  ...
  def test_testCase0(self):
    ...
    self.driver.find_element(By.ID, "mail").send_keys("abc@gmail.com")
    self.driver.find_element(By.ID, "passwords").send_keys("123")
    ...
    self.driver.find_element(By.ID, "anime_title").send_keys("Dororo")
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".anidetails_search_title:nth-child(1) > #anime_title").send_keys("One Piece")
